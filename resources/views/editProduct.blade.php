    ...
    <div class="col-sm-6">
        ...
        <form action="{{route('updateProduct')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <img src="{{asset('image')}}/{{$product->image}}" alt="" width="100" class="img-fluid"><br>
            ...
            <div class="form-group">
                <label for="productName">Image</label>
                    <input class="form-control" type="file" id="productImage" name="productImage" required value="{{$product->name}}">
            </div>
            <div class="form-group">
                <label for="productQuantity">Quantity</label>
                    <input class="form-control" type="number" min="0" max="100"id="productQuantity" name="productQuantity" required value="{{$product->quantity}}">
            </div>
